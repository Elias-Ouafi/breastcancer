...
def build_model(base_channels=32):
    ...
    removed after being measured (plan.md §4.1): validation Dice sat at 0.000 from
    ...
    having it. The idea worth reviving is narrower and is recorded in plan.md §4.1:
